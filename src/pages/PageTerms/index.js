    ...
    <main className="main pages" style={{"transform":": none"}}>
        <div className="page-header breadcrumb-wrap">
            <div className="container">
                ...
                <NavLink to="/home" className="active"><i className="fi-rs-home mr-5"></i>Home</NavLink>
        ...
        <div className="page-content pt-50" style={{"transform":": none"}}>
            <div className="container" style={{"transform":": none"}}>
                <div className="row" style={{"transform":": none"}}>
                    <div className="col-xl-10 col-lg-12 m-auto" style={{"transform":": none"}}>
                        <div className="row" style={{"transform":": none"}}>
                            ...
                            <div className="col-lg-3 primary-sidebar sticky-sidebar" style={{"position": "relative", "overflow": "visible", "boxSizing": "border-box", "minHeight": "1px"}}>
                                
                            <div className="theiaStickySidebar" style={{paddingTop: "0px", paddingBottom: "1px", position: "static", transform: "none", top: "0px", left: "967.531px"}}>
                                <div className="widget-area">
                                    ...
                                    <div className="sidebar-widget widget-category-2 mb-30">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-1.svg" alt="" />Milks &amp; Dairies</a><span className="count">2</span>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-2.svg" alt="" />Clothing</a><span className="count">0</span>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods </a><span className="count">42</span>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</a><span className="count">33</span>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</a><span className="count">10</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="banner-img wow fadeIn mb-40 animated d-lg-block d-none animated" style={{"visibility": "visible"}}>
