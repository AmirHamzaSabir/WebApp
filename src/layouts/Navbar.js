                    ...
                    <ul>
                      ...
                      <li>
                        <a className="language-dropdown-active" href="#">
                          <i className="fi-rs-angle-small-down"></i> English
                        </a>
                        <ul className="language-dropdown">
                          ...
                          <li>
                            <a href="#">
                              <img src="/images/flag-dt.png" alt />
                              Deutsch
                            </a>
                          </li>
                          <li>
                      ...
                      <li>
                        <a className="language-dropdown-active" href="#">
                          <i className="fi-rs-angle-small-down"></i> USD
                        </a>
                        <ul className="language-dropdown">
                          <li>
                            <a href="#">
                    ...
                    <div className="header-action-2">
                      ...
                      <div className="header-action-icon-2">
                        <a className="mini-cart-icon" href="shop-cart.html">
                          <img alt="Nest" src="/fonts/icon-cart.svg" />
            ...
            <div className="container">
              <div className="header-wrap header-space-between position-relative">
                      ...
                      <div className="d-flex categori-dropdown-inner">
                        <ul>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-1.svg" alt />
                              Milks and Dairies
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-2.svg" alt />
                              Clothing & beauty
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-3.svg" alt />
                              Pet Foods & Toy
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-4.svg" alt />
                              Baking material
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-5.svg" alt />
                              Fresh Fruit
                            </a>
                          </li>
                        </ul>
                        <ul className="end">
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-6.svg" alt />
                              Wines & Drinks
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-7.svg" alt />
                              Fresh Seafood
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-8.svg" alt />
                              Fast food
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-9.svg" alt />
                              Vegetables
                            </a>
                          </li>
                          <li>
                            <a href="shop-grid-right.html">
                              {" "}
                              <img src="/fonts/category-10.svg" alt />
                              Bread and Juice
                            </a>
                          </li>
                        </ul>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <ul className="sub-menu">
                            ...
                            <li>
                            <NavLink to="/page-terms" className="active">Terms of Service</NavLink>
                            </li>
                            <li>
                ...
                <div className="hotline d-none d-lg-flex">
                  <img src="/fonts/icon-headphone.svg" alt="hotline" />
                  <p>
                ...
                <div className="header-action-right d-block d-lg-none">
                  <div className="header-action-2">
                    <div className="header-action-icon-2">
                      <a href="shop-wishlist.html">
                        <img alt="Nest" src="/fonts/icon-heart.svg" />
